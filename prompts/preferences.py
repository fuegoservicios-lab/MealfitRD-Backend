...
- 🔴 OPCIÓN A (Alternativa 1) -> El Almuerzo o Cena principal DEBE incluir obligatoriamente: {protein_0} + {carb_0} y como acompañante vegetal/grasa: {veggie_0}. En las DEMÁS comidas del día (desayuno/merienda), usa: {veggie_0b}. Frutas asignadas al día (usa una DISTINTA en cada comida que lleve fruta, NUNCA la misma dos veces el mismo día): {fruit_0} y {fruit_0b}.
- 🔵 OPCIÓN B (Alternativa 2) -> El Almuerzo o Cena principal DEBE incluir obligatoriamente: {protein_1} + {carb_1} y como acompañante vegetal/grasa: {veggie_1}. En las DEMÁS comidas del día (desayuno/merienda), usa: {veggie_1b}. Frutas asignadas al día (usa una DISTINTA en cada comida que lleve fruta, NUNCA la misma dos veces el mismo día): {fruit_1} y {fruit_1b}.
- 🟢 OPCIÓN C (Alternativa 3) -> El Almuerzo o Cena principal DEBE incluir obligatoriamente: {protein_2} + {carb_2} y como acompañante vegetal/grasa: {veggie_2}. En las DEMÁS comidas del día (desayuno/merienda), usa: {veggie_2b}. Frutas asignadas al día (usa una DISTINTA en cada comida que lleve fruta, NUNCA la misma dos veces el mismo día): {fruit_2} y {fruit_2b}.
