...
Vigente desde `P1-PLAN-LOTE-222` (2026-09-24); las secciones de abajo son la historia de cómo se llegó aquí.
...
## La hora la eliges tú (`P1-PLAN-LOTE-222` · 2026-09-24)
...
Lo que no cambia: el tope diario, las horas de silencio (la hora elegida tampoco puede caer antes de las 6:00: el servidor la rechaza y Configuración no deja elegirla), el anti-spam de una hora y el tono adaptativo. Test ancla: [`test_p1_plan_lote_222.py`](../tests/test_p1_plan_lote_222.py).
