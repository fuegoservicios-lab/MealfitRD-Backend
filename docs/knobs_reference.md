...
| `MEALFIT_LISTA_DESDE_PASOS` | `True` | [P1-PLAN-LOTE-191] lo que un paso MIDE («mide 20 g de harina de Negrito») y la lista no trae entra a la lista antes de las guardas (generación), y las guardas clínicas de cambiar plato/chat/días deterministas lo escanean en una copia. Tope 2 por comida, 3–300 g, sin notas ni agua/sal. |
| `MEALFIT_SEED_NUT_LINE_CAP_G` | `40` | [P1-PLAN-LOTE-193] techo por línea de semillas/frutos secos (`_SEED_NUT_TOKENS`) en el bucle de topes del escudo pre-INSERT; leches, harinas, aceites, yogures y quesos vegetales fuera. 0 = apagado. |
| `MEALFIT_CANNED_FISH_LINE_CAP_G` | `170` | [P1-PLAN-LOTE-193] techo por línea de pescado en lata (atún, sardinas, caballa, arenque «en agua/en lata/escurrido») en el mismo bucle: 5 líneas de 280–300 g de atún en las corridas guardadas, dos en embarazo. 0 = apagado. |
| `MEALFIT_PIECE_FRACTIONS` | `True` | [P1-PLAN-LOTE-194] los cortes de una pieza («rodaja», «lasca», «tajada», «gajo», «rueda») se leen como fracción de la unidad (⅛, ⅛, ⅕, 1/10, ⅛) en `nutrition_db` y en `shopping_calculator._parse_quantity`; False = la conducta previa (pieza entera). |
| `MEALFIT_PREGNANCY_FISH_CAP_G` | `340` | [P1-PLAN-LOTE-187] embarazo/lactancia (dieta omnívora): tope de pescado y marisco por cada 7 días; el plato que lo pasa cambia su pescado por la misma cantidad de una proteína que ese día no se repita. 0 = apagado. |
