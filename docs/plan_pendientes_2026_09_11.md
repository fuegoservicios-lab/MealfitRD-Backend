...
| C8 | ✅ 2026-09-11 · curado por el DUEÑO | `P1-PLAN-LOTE-11`: las 4 plantillas DO sin receta congelada, juzgadas plato a plato en la ficha interactiva (https://claude.ai/code/artifact/0918e0a8-ab5f-4789-b83a-39edc3663023): 3 «con cambios» → renombradas a lo que traen («Frutas picadas con limón», «Mangú con jamón de pavo a la plancha», «Filete de pescado blanco al horno con vegetales y batata»), id estable vía `TEMPLATE_ALIASES`, recetas en `recipe_library_do_v1.json` v7 con sus cambios; 1 ❌ («Batida de zapote ligera»: sin zapote en el catálogo) retirada del registry. DO: 193/193 `ok`, 0 `partial`; firma curatorial re-anclada, benchmark y baseline C3 regenerados. No aplicado literal: el rótulo «Jugo de limón» (el día determinista resuelve el catálogo por nombre canónico). Hallazgo: `dish_constituents_do.json` es el SSOT, su script ya no lo reproduce (75 entradas) |
