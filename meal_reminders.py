...
El minuto: [P1-PLAN-LOTE-222] la notificación local suena a la hora EXACTA del aviso (la que la persona eligió en
...
def _hora_y_minuto(user_id: str, meal: str, health: Optional[dict]) -> tuple:
    ...
    # 59,7 acabe en «:60». [P1-PLAN-LOTE-222] con la misma función que el cron: el chat y el teléfono, el mismo minuto.
...
def horario_de_avisos(user_id: str, locale: Optional[str] = None, consumed_today=None,
    ...
    [P1-PLAN-LOTE-222] Tampoco el de una comida que la persona apagó en Configuración, y la hora es la que eligió."""
    import proactive_agent as pa
...
def comidas_para_configuracion(user_id: str, health: Optional[dict] = None) -> list:
    """[P1-PLAN-LOTE-222] Las CUATRO comidas como las pinta Configuración: `{meal, active, hour, minute, chosen,
