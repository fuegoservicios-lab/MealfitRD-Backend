...
def test_last_known_pfix_bumped():
    ...
    WEIGHT-UNIT-AUTOCONVERT (2026-05-20) varios P-fixes más avanzaron el
    marker (hoy `P2-TRIAGE-REALBUGS · 2026-06-16`). Asertar el slug literal
    de este fix iría stale por diseño; lo que SÍ es invariante es que el
    marker nunca regrese antes de la fecha en que este fix aterrizó.
    """
