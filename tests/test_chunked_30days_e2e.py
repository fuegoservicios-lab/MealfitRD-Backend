...
def _setup_30day_plan(user_id, plan_id, seed_lessons=None, pre_days=None,
    ...
    # GLM REAL el chunk 9 sintético del test (plan 3c112666) — el flake 9_10 era
...
def test_chunked_30days_e2e_full_plan(mock_pipeline, seeded_user_profile, _coherencia_t2_warn_only):
...
@pytest.mark.e2e
@patch('cron_tasks.run_plan_pipeline', side_effect=_mock_run_plan_pipeline)
def test_chunked_30days_lifetime_lessons_accumulate(mock_pipeline, seeded_user_profile, _coherencia_t2_warn_only):
...
@pytest.mark.e2e
@patch('cron_tasks.run_plan_pipeline', side_effect=_mock_run_plan_pipeline)
def test_chunked_30days_final_chunks_9_10_complete(mock_pipeline, seeded_user_profile, _coherencia_t2_warn_only):
