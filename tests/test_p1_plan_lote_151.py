...
def test_el_aviso_no_puede_salirse_por_arriba_de_la_franja_de_su_comida(monkeypatch):
    ...
    [P1-PLAN-LOTE-222] El acotado vive ahora en el camino por historial (knob `MEALFIT_PROACTIVE_NUDGE_FROM_HISTORY`):
...
def test_el_lado_TEMPRANO_no_se_acota_a_proposito(monkeypatch):
    ...
    puede ADELANTAR un aviso; nunca retrasarlo. [P1-PLAN-LOTE-222] Camino por historial, detrás de su knob."""
    import db_facts
    import proactive_agent as pa
