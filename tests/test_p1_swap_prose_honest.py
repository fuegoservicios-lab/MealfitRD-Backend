...
# [P1-SUBST-STALE-STEP · 2026-08-01, movido en ronda 4b] Los 5 tests del defecto real (plan de
# producción 5f4bb17e-14cb-4db3-8d97-79933af690cf, score 97.2 — "Hierve el huevo..." colgando
# tras el swap huevo→yogur) más los nuevos de la reescritura por CLÁUSULA viven ahora en
# `tests/test_p1_subst_stale_step.py` — el marker consolidado ahí matchea el slug que
# `test_p2_hist_audit_14_marker_test_link.py` exige de `_LAST_KNOWN_PFIX`.
