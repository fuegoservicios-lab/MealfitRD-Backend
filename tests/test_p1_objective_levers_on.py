...
def test_p1_6_raw_staple_is_separate_from_low_quality_gate():
    ...
    # [P1-DISH-QUALITY-GATE-ON · 2026-07-02] el soft-gate está ON (datos flota: low_quality_ratio=0.0), pero
    # usa SOLO low_quality_ratio, NUNCA raw_staple → "Arroz Blanco" con receta real jamás dispara el gate
    # (cero falso positivo — la separación de señales que este test ancla sigue intacta).
