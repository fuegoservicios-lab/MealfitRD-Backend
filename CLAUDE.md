...
[P3-CHAT-SAFETY-OFF-DECISION · 2026-05-20 · superseded P0-DEEPSEEK-MIGRATION 2026-06-12] Aplicaba a los content-filters de Gemini (`DANGEROUS_CONTENT` + `safety_settings`) por false-positives en charlas de déficit/ayuno. DeepSeek no los expone client-side: el bloque salió de [agent.py](backend/agent.py) y la intención la cubre el default del provider. Detalle: memoria `project_p3_chat_safety_off_decision_2026_05_20`.
