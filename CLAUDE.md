...
[P1-ARQ25-F1-LIFECYCLE · 2026-09-02] Bloque 1 = chunk `initial` de `plan_chunk_queue` (placeholder en `meal_plans`, I1); `attempts` = token de fencing (I10); `revision` por trigger (I12). Doc `backend/docs/generation_lifecycle_2_5.md`; test `test_p1_arq25_f1_lifecycle.py`.
