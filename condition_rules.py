...
CONDITION_RULES: tuple = (
    ...
    ConditionRule(
        ...
        prompt_block=(
            ...
            "   • NUECES Y SEMILLAS SIEMPRE MOLIDAS O EN MANTEQUILLA (mantequilla de maní/almendras, linaza "
            "molida), NUNCA enteras: maní, almendras, nueces, pistachos, semillas de chía/calabaza/girasol "
            "enteras tienen riesgo de OBSTRUCCIÓN del pouch/anastomosis. Porción pequeña medida.\n"
            "   • CONDIMENTOS ACOTADOS POR DÍA (no por comida — SUMA todas las comidas del día):\n"
            "     ◦ LINAZA / CHÍA / AJONJOLÍ MOLIDA: máximo 1 cucharada (≈10 g) en TODO el día. No las repitas en "
            "varias comidas — desplazan la proteína del pouch y el bolo de fibra concentrada se tolera mal.\n"
            "     ◦ CANELA: máximo ½ cucharadita en TODO el día (suma Desayuno + Meriendas + Cena). En exceso la "
            "cumarina (canela cassia) es hepatotóxica y la canela provoca hipoglucemia reactiva. Si pusiste canela "
            "en el desayuno, CERO canela en las demás comidas del día.\n"
            "   • COHERENCIA NOMBRE ↔ INGREDIENTES (OBLIGATORIO, SIN INGREDIENTES FANTASMA): todo alimento nombrado "
            "en el TÍTULO del plato DEBE estar en la lista de ingredientes ('Batido de Guineo' lleva guineo). Y NO "
            "metas un alimento que NO está en el título ('½ papa' dentro de un 'Yogurt con Lechosa' está PROHIBIDO; "
            "mantequilla de maní o casabe dentro de una 'Infusión de Manzanilla' está PROHIBIDO).\n"
            "   • CRUDOS PROHIBIDOS (hipoclorhidria post-bariátrica → menos barrera contra patógenos): nada de "
            "pescado/mariscos crudos (ceviche, sushi), carne cruda/poco hecha, ni huevo con yema líquida. TODO bien "
            "cocido. CAFEÍNA limitada: máximo 1 taza de café/día (mejor descafeinado), nunca en ayunas; JAMÁS "
            "bebidas energéticas ni gaseosas (el gas distiende el pouch).\n"
