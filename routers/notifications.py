...
def _meal_reminders_sync(user_id: str, canal: str = "") -> dict:
    ...
    # [P1-PLAN-LOTE-223] `reminders_before_hour`: Configuración solo deja elegir horas de `quiet_until_hour` a antes
    ...
    # [P1-PLAN-LOTE-223] Las cuatro comidas con su interruptor y su hora, para Configuración (también las apagadas, y
    ...
    try:
        ...
        logger.warning(f"[P1-PLAN-LOTE-223] horas de Configuración de {user_id} no calculadas: {e!r}")
        base["comidas"] = []
