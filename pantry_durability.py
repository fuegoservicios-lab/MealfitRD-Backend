...
_RULES: tuple[tuple[tuple[str, ...], str, int], ...] = (
    ...
    (("queso de papa", "queso gouda", "queso cheddar", "queso parmesano", "queso provolone", "queso mozzarella",
      "queso en hebras", "mantequilla"), "cold", 30),
    ...
    (("ajo",), "cold", 90),
    (("cebolla", "papa", "batata", "name", "auyama", "repollo", "zanahoria", "remolacha", "jengibre", "manzana",
      "coco", "granada", "membrillo"), "cold", 30),
    (("yautia", "yuca", "mapuey", "nabo", "tayota", "jicama", "naranja", "limon", "toronja", "mandarina", "kiwi",
      "pera", "chinola", "uchuva", "borojo", "xoconostle", "chontaduro", "arracacha", "panapen", "tortilla de trigo",
      "tortilla integral", "tortilla de maiz"), "cold", 21),
