...
"""
    ...
    if is_skip_lunch_active:
        skip_lunch_instruction = "\n\n⚠️ INSTRUCCIÓN CRÍTICA Y OBLIGATORIA DE ESTRUCTURA ⚠️\nEl usuario indicó 'Almuerzo Familiar / Ya resuelto' (`skipLunch: true`). ESTÁ TOTAL Y ABSOLUTAMENTE PROHIBIDO incluir la comida 'Almuerzo' en este plan. Si incluyes un Almuerzo, el plan será rechazado. \nDebes generar EXACTAMENTE 3 comidas por el día entero: 'Desayuno', 'Merienda' y 'Cena'. \nIMPORTANTE PARA TU 'Estrategia' o 'PLAN DE ACCIÓN': Las calorías objetivo que recibes YA TIENEN DESCONTADA una gran porción para ese almuerzo libre. Esto significa que tu estrategia es planificar desayunos, meriendas y cenas MÁS LIGERAS de lo normal para dejar ese espacio calórico invisible libre para su familia. NUNCA digas que estás concentrando las calorías en el desayuno/cena, sino al revés: estás aligerando el resto del día para hacer espacio al gran almuerzo familiar libre."
